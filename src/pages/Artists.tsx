    ...
    >
      ...
      <div className="flex flex-col border-t border-black">
        {ARTISTS.map((artist, i) => (
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-12 items-start gap-8 px-4">
              <div className="lg:col-span-1 text-xs font-black opacity-30">0{i+1}</div>
              
              <div className="lg:col-span-4">
                <h2 className="text-4xl lg:text-6xl font-black uppercase tracking-tighter mb-2 leading-none">
                  {artist.name}
                </h2>
